...
#         dados_py = dados_js.to_list()
#         return dados_py

#     def get_projects(self, token: str) -> list[dict]:
#         try:
#             data = {
#                 "start": "0",
#                 "limit": "100",
...
#             response = requests.post(url=efinance_url, data=data)
#             response.raise_for_status()

#             raw_text = response.text

#             data = self.extract_data(raw_text)
...
#     def get_environments(self, token: str, order_number: str, contract_number: str) -> list[dict]:
#         try:
#             data = {
#                 "Acao": "carregaGrid",
#                 "loja": "172",
...
#                     "environment": item.get("PRO_Ambiente"),
...
#     def get_reservations(self, token: str, order_number: str, contract_number: str) -> list[dict]:
#         try:
#             data = {
